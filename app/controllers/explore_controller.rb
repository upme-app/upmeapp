class ExploreController < ApplicationController
  ...
  def index
    @all_areas = AreaDeInteresse.where(name: ["Engenharias", "Arquitetura", "Administração"])
    ...
    if params and params[:areas_interesse].present?
      ...
      @selected_areas = AreaDeInteresse.where(name: ["Engenharias", "Arquitetura", "Administração"])
    end
